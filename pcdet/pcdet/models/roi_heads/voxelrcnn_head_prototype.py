...
class VoxelRCNNHead_prototype(RoIHeadTemplate):
    ...
    def get_box_cls_layer_loss(self, forward_ret_dict):
        ...
        mask = forward_ret_dict['gt_iou_of_rois'] == 0
        rcnn_cls_labels = forward_ret_dict['rcnn_cls_labels']
        rcnn_cls_labels[mask] = forward_ret_dict['roi_scores'][mask]
        rcnn_cls_labels = rcnn_cls_labels.view(-1)
