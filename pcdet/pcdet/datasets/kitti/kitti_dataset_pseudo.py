...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, info_path, workers=4):
    dataset = KittiDataset_pseudo(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
    ...
    kitti_infos_train = dataset.get_infos(info_path=info_path, num_workers=workers, has_label=True, has_pseudo_label=True, count_inside_pts=True)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            info_path=ROOT_DIR / '..' / 'data' / 'kitti' / 'kitti_data_info.pkl'
        )
