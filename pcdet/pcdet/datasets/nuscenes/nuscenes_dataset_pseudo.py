...
class NuScenesDataset_pseudo(DatasetTemplate):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        from . import nuscenes_utils_pseudo
        nusc = NuScenes(version=self.dataset_cfg.VERSION, dataroot=str(self.root_path), verbose=True)
        nusc_annos = nuscenes_utils_pseudo.transform_det_annos_to_nusc_annos(det_annos, nusc)
        nusc_annos['meta'] = {
            'use_camera': False,
            'use_lidar': True,
            'use_radar': False,
        ...
        result_str, result_dict = nuscenes_utils_pseudo.format_nuscene_results(metrics, self.class_names)
...
def create_nuscenes_info(version, data_path, save_path, max_sweeps=10, with_cam=False):
    ...
    available_scenes = nuscenes_utils_pseudo.get_available_scenes(nusc)
    ...
    train_nusc_infos, val_nusc_infos = nuscenes_utils_pseudo.fill_trainval_infos(
...
if __name__ == '__main__':
    ...
    if args.func == 'create_nuscenes_infos':
        ...
        # nuscenes_dataset = NuScenesDataset_pseudo(
